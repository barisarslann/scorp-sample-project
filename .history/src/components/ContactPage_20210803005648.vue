<template>
    <div class="container contact-page">
        ...
        <div class="contact-form">
            ...
            <input type="text" v-model="search" @click="testF">
            <ul class="country-list" v-if="tested">
                <li v-for="country in searchedCountry" @click="selectCountry(country.id); tested = false" :key="country.id" class="country-list-item">{{ country.name }}</li>
            </ul>
