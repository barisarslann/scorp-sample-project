<template>
    <div class="container contact-page">
        ...
        <div class="contact-form">
            ...
            <textarea name="message" v-model="formData.text" placeholder="Message" rows="2"></textarea>
            <input type="text" v-model="search">
            <ul class="country-list">
                <li v-for="country in searchedCountry" @click="selectCountry(country.id)" :key="country.id" class="country-list-item">{{ country.name }}</li>
            </ul>
